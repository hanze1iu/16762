...
robot.end_of_arm.move_to('wrist_yaw', np.radians(8))
robot.push_command()
robot.end_of_arm.wait_until_at_setpoint()

robot.end_of_arm.move_to('wrist_pitch', np.radians(8))
robot.push_command()
robot.end_of_arm.wait_until_at_setpoint()

robot.end_of_arm.move_to('wrist_roll', np.radians(20))
robot.push_command()
robot.end_of_arm.wait_until_at_setpoint()
...
robot.base.rotate_by(np.radians(190))
robot.push_command()
robot.base.wait_until_at_setpoint()
